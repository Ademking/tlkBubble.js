const tlkBubble = n => {
    const e = (() => {
            ...
            return document.head.append(n), e => n.textContent = e
        })(),
        t = n.bubbleColor || "linear-gradient(160deg, #0093E9 0%, #80D0C7 100%);",
    ...
    let r = "";
    r = void 0 === n.username ? "//embed.tlk.io/test" : `//embed.tlk.io/test?nickname=${n.username}`;
    var i = document.createElement("div");
    i.innerHTML = `<div id="bubble-btn" class="btn-bubble">\n    <div class="fab fab-icon-holder">\n        ${o}\n    </div>\n    </div>\n    <div id="chatroom-iframe-wrapper" class="noselect">\n      <iframe src="${r}" style="width: 100%; height: 100%; margin-bottom: -8px" frameborder="0"></iframe>\n    </div>`, i.onclick = (() => {
        let n = document.getElementById("chatroom-iframe-wrapper").style.width;
        document.getElementById("chatroom-iframe-wrapper").style.width = "0px" === n || "" === n ? "350px" : "0px"
